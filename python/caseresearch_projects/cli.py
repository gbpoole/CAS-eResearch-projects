...
import caseresearch_projects.files as files
...
@click.version_option(importlib.metadata.version("caseresearch_projects"))
@click.pass_context
def cli(ctx: click.core.Context) -> None:
    """Run code from the caseresearch_projects package."""
